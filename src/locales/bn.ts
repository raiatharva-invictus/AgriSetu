...
export const bn: Record<LocaleKeys, string> = {
  ...
  // CASES FEATURE
  myCasesTitle: 'আমার ফসলের সমস্যা (My Cases)',
  myCasesSub: 'ফসলের চিকিৎসা ও উন্নতির অগ্রগতি দেখুন',
  activeCasesGroup: 'সক্রিয় সমস্যা (ACTIVE)',
  pastCasesGroup: 'পুরানো সমস্যা (PAST)',
  noActiveCases: 'কোনো সক্রিয় সমস্যা নেই',
  noPastCases: 'কোনো পুরানো কেস রেকর্ড নেই',
  timelineTitle: 'অগ্রগতি পর্যায় (Timeline)',
  problemSectionHeader: 'সমস্যা (PROBLEM)',
  expertSectionHeader: 'কৃষি বিশেষজ্ঞ (EXPERT)',
  consultationSectionHeader: 'পরামর্শ (CONSULTATION)',
  adviceSectionHeader: 'বিজ্ঞানীর পরামর্শ (ADVICE)',
  followUpQuestion: 'ফসলের কি উন্নতি হয়েছে?',
  solvedOpt: 'হ্যাঁ, সম্পূর্ণ ঠিক হয়েছে',
  partiallySolvedOpt: 'আংশিক উন্নতি হয়েছে',
  unresolvedOpt: 'এখনও সমাধান হয়নি',
  unresolvedReMatchNotice: 'এই সমস্যার জন্য অন্য কোনো বিজ্ঞানীর পরামর্শ প্রয়োজন হতে পারে।',
  findAnotherExpertBtn: 'অন্য কৃষি বিশেষজ্ঞ খুঁজুন',
  whyMatchedHeader: 'কেন এই বিশেষজ্ঞ নির্বাচন করা হয়েছে:',
  reportedDateLabel: 'রিপোর্ট তারিখ',
  statusLabel: 'অবস্থা',
  feedbackPlaceholder: 'ঐচ্ছিক: আপনার ফসলের উন্নতির বিবরণ লিখুন...',
  submitOutcomeBtn: 'ফলাফল সংরক্ষণ করুন',
