...
export const hi: Record<LocaleKeys, string> = {
  ...
  // CASES FEATURE
  myCasesTitle: 'मेरी फसल समस्याएं (My Cases)',
  myCasesSub: 'आपकी फसलों के उपचार की स्थिति व प्रगति',
  activeCasesGroup: 'सक्रिय समस्याएं (ACTIVE)',
  pastCasesGroup: 'पूर्व समस्याएं (PAST)',
  noActiveCases: 'कोई सक्रिय फसल समस्या नहीं है',
  noPastCases: 'कोई पुरानी समस्या दर्ज नहीं है',
  timelineTitle: 'प्रगति चक्र (Case Timeline)',
  problemSectionHeader: 'फसल समस्या (PROBLEM)',
  expertSectionHeader: 'कृषि विशेषज्ञ (EXPERT)',
  consultationSectionHeader: 'परामर्श (CONSULTATION)',
  adviceSectionHeader: 'वैज्ञानिक सलाह (ADVICE)',
  followUpQuestion: 'क्या फसल में सुधार हुआ है?',
  solvedOpt: 'हाँ, पूरी तरह ठीक है',
  partiallySolvedOpt: 'आंशिक सुधार हुआ',
  unresolvedOpt: 'अभी भी ठीक नहीं हुआ',
  unresolvedReMatchNotice: 'इस समस्या के लिए दूसरी वैज्ञानिक राय की आवश्यकता हो सकती है।',
  findAnotherExpertBtn: 'दूसरा कृषि विशेषज्ञ खोजें',
  whyMatchedHeader: 'विशेषज्ञ क्यों चुने गए:',
  reportedDateLabel: 'दर्ज तिथि',
  statusLabel: 'स्थिति',
  feedbackPlaceholder: 'ऐच्छिक: फसल सुधार का विवरण लिखें...',
  submitOutcomeBtn: 'फसल स्थिति दर्ज करें',
