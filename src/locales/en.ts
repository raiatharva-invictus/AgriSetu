export const en = {
  ...
  myCasesSub: 'Track ongoing crop guidance & recovery progress',
  activeCasesGroup: 'ACTIVE',
  pastCasesGroup: 'PAST',
  noActiveCases: 'No active crop cases',
  noPastCases: 'No past completed cases',
  timelineTitle: 'Case Timeline',
  problemSectionHeader: 'PROBLEM',
  expertSectionHeader: 'EXPERT',
  consultationSectionHeader: 'CONSULTATION',
  adviceSectionHeader: 'ADVICE & RECOMMENDATIONS',
  followUpQuestion: 'Has the crop improved?',
  solvedOpt: 'Solved',
  partiallySolvedOpt: 'Partially improved',
  unresolvedOpt: 'Still unresolved',
  unresolvedReMatchNotice: 'The problem may need another opinion.',
  findAnotherExpertBtn: 'Find another expert',
  whyMatchedHeader: 'Why matched:',
  reportedDateLabel: 'Reported',
  statusLabel: 'Status',
  feedbackPlaceholder: 'Optional: Describe how your crop is recovering...',
  submitOutcomeBtn: 'Save Recovery Outcome',
